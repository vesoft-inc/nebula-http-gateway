...
import (
	...
	storage2_5_0 "github.com/vesoft-inc/nebula-http-gateway/ccore/nebula/internal/thrift/v2_5_0/storage"
...
type (
	defaultStorageAdminClient struct {
		storageAdmin *storage2_5_0.StorageAdminServiceClient
	}
)
...
func newStorageAdminClient(transport thrift.Transport, pf thrift.ProtocolFactory) types.StorageAdminClientDriver {
	return &defaultStorageAdminClient{
		storageAdmin: storage2_5_0.NewStorageAdminServiceClientFactory(transport, pf),
	}
}
